...
int main() {
    ...
    opr_smanji.sem_op = -1; // nad semaforom 1, odradi -1
    ...
    opr_povecaj.sem_op = 1; // nad semaforom 0, odradi +1
    opr_povecaj.sem_flg = 0;

    int status;
    while (1) {

        // proces moze da udje u kriticni region samo ukoliko postoji mogucnost
        // da se nad semaforom 1 odradi operacija umanjenja

        // posto je inicijalno vrednost 1-og semafora [0]
        // on ce cekati sve dok ping.c ne uveca vrednost 1-og semafora na 1
        ...
        // po izlasku iz kriticnog regiona, povecaj vrednost 0-og semafora (tren [0]) na [1]
        // kako bi prvi proces (ping.c) mogao da udje u kriticni region umanjenjem tog semafora za 1
