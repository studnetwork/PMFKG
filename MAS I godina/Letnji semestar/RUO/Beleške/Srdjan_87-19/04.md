...
pristupiti preko UI-a ili CLI-a. Oni šalju zahtev njegov API.
...
i neki deljeni resurs između tih kontejnera, npr. i volume, ali o tome 
...
novu verziju (mogu istovremeno obe verzije da se koriste). Rolling update
To je korisno za A/B testing.
