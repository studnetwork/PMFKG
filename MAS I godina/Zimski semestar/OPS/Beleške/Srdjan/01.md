...
Koristimo ih kako bismo dobili brojno stanje grupa koje su dobijene ukrstanjem dva kategorijska obelezja.
...
1. Nultu / Afirmativnu: `H0` (njom se nesto tvrdi)
2. Alternativnu: `H1` (suprotno od nulte)
...
Za testove normalnosti, H0 kaze **obelezje ima normalnu raspodelu na nivou populacije.**

H1 kaze **obelezje nema normalnu raspodelu na nivou populacije**.
...
1. ako je p-value vece od alfa, onda se prihvata H0
2. ako je p-value manje ili jednako alfa, prihvatamo H1
...
To su dva razlicita testa koja testiraju istu stvar. Posto se testira isto, ista je i H0.
