...
zamemariti onda se odbacuje $H_{0}$ (i time prihvatamo $H_{1}$), a ako je dovoljno velika da moze da se tolerise, 
prihvatamo $H_{0}$.
...
znati samo nultu hipotezu. Taj metod predstavlja koriscenje p-vrednosti i njego poredjenje
sa alfom.
